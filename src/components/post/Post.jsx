...
const Post = ({ post }) => {
  ...
  const handleLikePost = async () => {
    try {
      await fetch(`${API}/post/toggleLike/${post._id}`, {
        headers: {
          "Authorization": `Bearer ${token}`
        },
        method: "PUT"
  ...
  const handleBookmark = async () => {
    try {
      await fetch(`${API}/user/bookmark/${post._id}`, {
        headers: {
          "Authorization": `Bearer ${token}`
        },
        method: "PUT"
      ...
      <div className={classes.wrapper}>
        <div className={classes.top}>
          <Link to={`/profileDetail/${post?.user?._id}`} className={classes.topLeft}>
            <img src={`${API}/images/${post.user.profileImg}`} className={classes.profileUserImg} />
        ...
        <div className={classes.center}>
          ...
          <img className={classes.postImg} src={post?.photo ? `${API}/images/${post?.photo}` : woman} />
        </div>
